...
#         # # Adjust log_file for IDE environments
#         # if log_file and detect_ide():
#         #     log_file = f"{log_file}"
...
#     @classmethod
#     def set_logger(cls, logger: structlog.BoundLogger) -> None:
#         """Set logger instance from pytest fixture (called by conftest.py).

#         Args:
#             logger: Configured structlog logger instance bound with user context.
#         """
#         cls._logger = logger
